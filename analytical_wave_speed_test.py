    ...
    if time.time()>time_of_action[array_var - 1] + 0.2:
                        ...
                        if count>4:
                            ...
                            for x in z_axis_values:
                                if x>10:
                                    mini.append(x)
                                    timy.append(time_of_action[z_axis_values.index(x)])
                            z_min=min(mini)
                            z_max=max(mini)
                            if abs(z_max-z_min)>200:
                                ...
                                if mini.index(z_max)>mini.index(z_min):
                                    ...
                                    #print(mini)
                                    choice=1
                                    velocity=(abs(z_max-z_min)/abs(timy[mini.index(z_max)]-timy[mini.index(z_min)]))
                                    print(f"speed is {velocity}")
                                    if velocity>200 and velocity<1000:
                                        wave1.main_wave_generator(0,10)
                                    elif velocity>1000:
                                        wave1.main_wave_generator(0,20)
                                    else :
                                        wave1.main_wave_generator(0,5)
                                elif mini.index(z_max)<mini.index(z_min) :
                                    print("success2")
                                    velocity=(abs(z_max-z_min)/abs(timy[mini.index(z_max)]-timy[mini.index(z_min)]))
                                    print(f"speed is {velocity}")
                                    if velocity>200 and velocity<1000:
                                        wave1.main_wave_generator(1,10)
                                    elif velocity>1000:
                                        wave1.main_wave_generator(1,20)
                                    else :
                                        wave1.main_wave_generator(1,5)
